...
from omniintelligence.nodes.node_pattern_learning_compute.introspection import (
...
class TestModuleExports:
    ...
    def test_all_exports_importable(self) -> None:
        ...
        from omniintelligence.nodes.node_pattern_learning_compute import introspection
