...
try:
    ...
    from .node_context_keyword_extractor_compute import (
        ModelKeywordExtractionInput,
        ModelKeywordExtractionOutput,
        NodeContextKeywordExtractorCompute,
    )
    from .node_execution_trace_parser_compute import (
    ...
    from .node_success_criteria_matcher_compute import (
        ModelSuccessMatchingInput,
        ModelSuccessMatchingOutput,
        NodeSuccessCriteriaMatcherCompute,
    )
except ImportError:
    # Fall back to direct imports (when run as main)
    from node_context_keyword_extractor_compute import (
        ModelKeywordExtractionInput,
        ModelKeywordExtractionOutput,
        NodeContextKeywordExtractorCompute,
