...
class EntityTypeMapper:
    ...
    def auto_convert(
        ...
        """
        # Defensive check for typing constructs that shouldn't be here
        if hasattr(entity_type, "__module__") and entity_type.__module__ == "typing":
            # This is a typing construct (like Union), fallback to default
