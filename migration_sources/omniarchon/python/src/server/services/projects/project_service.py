...
class ProjectService:
    ...
    def create_project(
        ...
        try:
            ...
            if (
                github_repo
                and isinstance(github_repo, str)
                and len(github_repo.strip()) > 0
            ):
            ...
            return False, {"error": f"Database error: {e!s}"}
    ...
    def list_projects(
        ...
        try:
            ...
            return False, {"error": f"Error listing projects: {e!s}"}
    ...
    def get_project(self, project_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            ...
            return False, {"error": f"Error getting project: {e!s}"}
    ...
    def delete_project(self, project_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            ...
            return False, {"error": f"Error deleting project: {e!s}"}
    ...
    def get_project_features(self, project_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            ...
            return False, {"error": f"Error getting project features: {e!s}"}
    ...
    def update_project(
        ...
        try:
            ...
            return False, {"error": f"Error updating project: {e!s}"}
