...
class SourceLinkingService:
    ...
    def get_project_sources(self, project_id: str) -> tuple[bool, dict[str, list[str]]]:
        ...
        try:
            ...
            return False, {
                "error": f"Failed to retrieve linked sources: {e!s}",
                "technical_sources": [],
                "business_sources": [],
            }
            ...
            if technical_sources is not None:
                ...
                for source_id in technical_sources:
                    try:
                        ...
                        logger.warning(
                            f"Failed to link technical source {source_id}: {e}"
                        )
            ...
            if business_sources is not None:
                ...
                for source_id in business_sources:
                    try:
                        ...
                        logger.warning(
                            f"Failed to link business source {source_id}: {e}"
                        )
    ...
    def format_projects_with_sources(
