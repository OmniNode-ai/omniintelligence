...
class VersioningService:
    ...
    def create_version(
        ...
        try:
            ...
            version_data = {
                ...
                or f"{change_type.capitalize()} {field_name}",
            ...
            return False, {"error": f"Error creating version: {e!s}"}
    ...
    def list_versions(
        ...
        try:
            ...
            return False, {"error": f"Error getting version history: {e!s}"}
    ...
    def get_version_content(
        ...
        try:
            ...
            return False, {"error": f"Error getting version content: {e!s}"}
        ...
        try:
            ...
            if current_project.data:
                ...
                if not backup_result[0]:
                    logger.warning(
                        f"Failed to create backup version: {backup_result[1]}"
                    )
            ...
            return False, {"error": f"Error restoring version: {e!s}"}
