...
class KeywordExtractor:
    ...
    def extract_keywords(
        ...
        for token in tokens:
            ...
            if token in self.preserve_keywords or token not in self.stop_words:
    ...
    def _prioritize_keywords(
        self, keywords: list[str], original_query: str
    ) -> list[str]:
        """
...
def extract_keywords(
    query: str, min_length: int = 2, max_keywords: int = 10
) -> list[str]:
    """
