...
class RerankingStrategy:
    ...
    @classmethod
    def from_model(
        cls, model: Any, model_name: str = "custom_model"
    ) -> "RerankingStrategy":
        """
    ...
    def apply_rerank_scores(
        ...
        reranked_results = sorted(
            results, key=lambda x: x.get("rerank_score", -1.0), reverse=True
        )
...
class RerankingConfig:
    ...
    def from_credential_service(credential_service) -> dict[str, Any]:
        ...
        try:
            ...
            model_name = credential_service.get_setting(
    ...
    def from_env() -> dict[str, Any]:
        ...
        return {
            "enabled": os.getenv("USE_RERANKING", "false").lower()
            in ("true", "1", "yes", "on"),
