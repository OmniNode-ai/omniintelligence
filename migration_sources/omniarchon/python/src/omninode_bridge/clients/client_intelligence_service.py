...
try:
    from ...server.exceptions.onex_error import CoreErrorCode, OnexError
except ImportError:
...
class IntelligenceServiceClient:
    ...
    def __init__(
        ...
        Args:
            ...
            timeout_seconds: Request timeout in seconds (default: 30.0, increased from 10.0 to accommodate complex queries)
    ...
    async def assess_code_quality(
        ...
        try:
            ...
            logger.info(
                ...
                f"timeout={timeout_used}s | quality_score={result.quality_metrics.get('overall_score', 'N/A')}"
            )
