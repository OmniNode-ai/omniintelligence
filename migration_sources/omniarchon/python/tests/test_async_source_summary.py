            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        assert (
                            len(summary_call_times) == 1
                        ), "extract_source_summary should be called once"
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        assert (
                            ...
                            == "Documentation from test456 - 1 pages crawled"
                        )
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        all_metadatas = [
                            {"source_id": "test_update", "word_count": 100}
                        ]
                        all_contents = ["chunk1"]
                        ...
                        assert (
                            len(update_call_times) == 1
                        ), "update_source_info should be called once"
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        # Verify error was logged
                        assert any(
                            "Failed to create/update source record" in msg
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    assert (
                        captured_kwargs["original_url"] == "https://original.url/crawl"
                    )
                    assert captured_kwargs["source_url"] == "https://source.url"
                    assert (
                        captured_kwargs["source_display_name"] == "Source Display Name"
                    )
