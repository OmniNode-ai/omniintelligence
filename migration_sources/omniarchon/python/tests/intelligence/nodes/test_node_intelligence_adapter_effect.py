...
Test Pattern: Based on omninode_bridge test patterns
Reference: /omninode_bridge/tests/unit/nodes/database_adapter_effect/
"""

import sys
from pathlib import Path

# Add services/intelligence to path for imports
sys.path.insert(
...
try:
    from onex.contracts.model_intelligence_input import ModelIntelligenceInput
except ImportError:
    # Fallback if onex directory doesn't exist yet
    from unittest.mock import MagicMock

    ModelIntelligenceInput = MagicMock

# Import domain models
from intelligence.models.model_intelligence_config import ModelIntelligenceConfig
from intelligence.models.model_intelligence_output import ModelIntelligenceOutput
...
class TestNodeIntelligenceAdapterEffect:
    ...
    async def test_initialize_loads_config_and_client(
        ...
        with patch.object(
            ...
            with patch(
                "intelligence.nodes.node_intelligence_adapter_effect.IntelligenceServiceClient",
