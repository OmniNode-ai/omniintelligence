...
|----------|--------|-------|
| [ONEX Four-Node Architecture](architecture/ONEX_FOUR_NODE_ARCHITECTURE.md) | Active | Verified against code 2026-06-21; node-type counts, dispatch handler/route counts, contract-only and unregistered-node status re-derived from source |
