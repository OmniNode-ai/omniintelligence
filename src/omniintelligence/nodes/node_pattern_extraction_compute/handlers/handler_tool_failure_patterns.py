...
class _FailureRecord:
    ...
    timestamp: datetime
    tool_parameters: Mapping[str, object] | None
...
def _extract_path_value(params: Mapping[str, object] | None) -> str | None:
...
def _extract_directory(params: Mapping[str, object] | None) -> str | None:
...
def _extract_context_features(params: Mapping[str, object] | None) -> ContextFeatures:
