...
from omniintelligence.nodes.pattern_promotion_effect.models.model_promotion_request import (
    ModelPromotionCheckRequest,
)
from omniintelligence.nodes.pattern_promotion_effect.models.model_promotion_result import (
    ModelGateSnapshot,
