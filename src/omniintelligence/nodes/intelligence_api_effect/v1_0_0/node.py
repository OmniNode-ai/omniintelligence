"""
IntelligenceApi Effect Node - Official omnibase_core template structure
"""
import time
...
class NodeIntelligenceApiEffect(NodeOmniAgentEffect[
    ModelIntelligenceApiEffectInput,
    ModelIntelligenceApiEffectOutput,
    ModelIntelligenceApiEffectConfig
]):
    """Effect node for intelligence_api operations."""

    def __init__(self, config: ModelIntelligenceApiEffectConfig):
    ...
    async def process(self, input_data: ModelIntelligenceApiEffectInput) -> ModelIntelligenceApiEffectOutput:
        """Process intelligence_api operation with retry logic."""
        ...
        for attempt in range(self.config.max_retries + 1):
            try:
                ...
                return ModelIntelligenceApiEffectOutput(
    ...
    async def _execute_operation(self, input_data: ModelIntelligenceApiEffectInput) -> Dict[str, Any]:
