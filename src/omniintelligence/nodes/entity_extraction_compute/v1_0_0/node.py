"""
EntityExtraction Compute Node - Official omnibase_core template structure
"""
import time
...
class NodeEntityExtractionCompute(NodeOmniAgentCompute[
    ModelEntityExtractionComputeInput,
    ModelEntityExtractionComputeOutput,
    ModelEntityExtractionComputeConfig
]):
    """Compute node for entity_extraction operations."""

    def __init__(self, config: ModelEntityExtractionComputeConfig):
    ...
    async def process(self, input_data: ModelEntityExtractionComputeInput) -> ModelEntityExtractionComputeOutput:
        """Process entity_extraction operation."""
        ...
        try:
            ...
            return ModelEntityExtractionComputeOutput(
                success=True,
            ...
            raise ModelOnexError(
                ...
                message=f"entity_extraction failed: {str(e)}",
                cause=e
            )

    async def _execute_operation(self, input_data: ModelEntityExtractionComputeInput) -> Dict[str, Any]:
