...
This module allows running the compute node as a standalone service:
    python -m omniintelligence.nodes.vectorization_compute.v1_0_0
"""
...
async def main() -> None:
    ...
    logger.info("Starting Vectorization Compute Node v1.0.0")

    # Create compute node instance
    node = VectorizationCompute(container=None)
