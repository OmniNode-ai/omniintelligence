...
| 2 | 005 | `learned_patterns` | `supersedes` | `learned_patterns` | `id` | NO ACTION (implicit default; columns are nullable, self-cycle prevented by CHECK) | YES (self-ref) |
| 3 | 005 | `learned_patterns` | `superseded_by` | `learned_patterns` | `id` | NO ACTION (implicit default; columns are nullable, self-cycle prevented by CHECK) | YES (self-ref) |
